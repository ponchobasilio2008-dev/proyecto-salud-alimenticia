...
// Inicializamos las referencias de botones para ambas páginas
const btnImprimirIndividual = document.getElementById('btnImprimirIndividual');
const btnImprimirGeneral = document.getElementById('btnImprimirGeneral'); // <-- Usado en comunidad.html
...
if (btnImprimirGeneral) {
    btnImprimirGeneral.addEventListener('click', () => {
        ...
        registros.forEach(registro => {
            ...
            if (clasificacionesCount.hasOwnProperty(clasif)) {
                 ...
                 // Manejar registros antiguos que podrían tener clasificaciones diferentes
                 clasificacionesCount[clasif] = 1;
            }
        });
    ...
    // Nota: La lógica de mostrar/ocultar el botón en comunidad.html se maneja
    // en el script inline (código HTML) de esa misma página, asegurando que se ejecute al cargar.
}